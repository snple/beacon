...
const file_nodes_node_service_proto_rawDesc = "" +
	...
	"\x0fNodePushRequest\x12\x12\n" +
	"\x04nson\x18\x02 \x01(\fR\x04nson\"(\n" +
	"\x12NodeKeepAliveReply\x12\x12\n" +
	"\x04time\x18\x01 \x01(\x05R\x04time2\xd0\x01\n" +
	"\vNodeService\x129\n" +
	...
	"\x04Push\x12\x16.nodes.NodePushRequest\x1a\n" +
	".pb.MyBool\"\x00\x127\n" +
...
var file_nodes_node_service_proto_goTypes = []any{
	...
	(*NodePushRequest)(nil),    // 2: nodes.NodePushRequest
...
var file_nodes_node_service_proto_depIdxs = []int32{
	...
	5, // 2: nodes.NodeService.View:input_type -> pb.MyEmpty
	2, // 3: nodes.NodeService.Push:input_type -> nodes.NodePushRequest
	5, // 4: nodes.NodeService.KeepAlive:input_type -> pb.MyEmpty
	1, // 5: nodes.NodeService.Login:output_type -> nodes.NodeLoginReply
	4, // 6: nodes.NodeService.View:output_type -> pb.Node
	6, // 7: nodes.NodeService.Push:output_type -> pb.MyBool
	3, // 8: nodes.NodeService.KeepAlive:output_type -> nodes.NodeKeepAliveReply
