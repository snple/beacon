...
const (
	NodeService_Update_FullMethodName          = "/edges.NodeService/Update"
	NodeService_View_FullMethodName            = "/edges.NodeService/View"
	NodeService_Destory_FullMethodName         = "/edges.NodeService/Destory"
	NodeService_ViewWithDeleted_FullMethodName = "/edges.NodeService/ViewWithDeleted"
	NodeService_Sync_FullMethodName            = "/edges.NodeService/Sync"
)
...
func (c *nodeServiceClient) Destory(ctx context.Context, in *pb.MyEmpty, opts ...grpc.CallOption) (*pb.MyBool, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(pb.MyBool)
...
func (UnimplementedNodeServiceServer) Destory(context.Context, *pb.MyEmpty) (*pb.MyBool, error) {
...
func _NodeService_Destory_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(NodeServiceServer).Destory(ctx, req.(*pb.MyEmpty))
	}
	return interceptor(ctx, in, info, handler)
}
...
var NodeService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "edges/node_service.proto",
}
