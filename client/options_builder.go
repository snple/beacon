...
// RequestOptions 请求选项（Builder 模式）
type RequestOptions struct {
	TargetClientID string            // 目标客户端ID（可选，为空时由 core 选择）
...
func (o *RequestOptions) WithTargetClientID(clientID string) *RequestOptions {
	o.TargetClientID = clientID
	return o
}
...
// WithTraceID 设置追踪 ID
func (o *RequestOptions) WithTraceID(traceID string) *RequestOptions {
	o.TraceID = traceID
	return o
}

// WithContentType 设置内容类型
func (o *RequestOptions) WithContentType(contentType string) *RequestOptions {
	o.ContentType = contentType
	return o
}

// WithUserProperties 设置用户属性
func (o *RequestOptions) WithUserProperties(props map[string]string) *RequestOptions {
	o.UserProperties = props
	return o
}

// WithUserProperty 设置单个用户属性
func (o *RequestOptions) WithUserProperty(key, value string) *RequestOptions {
	if o.UserProperties == nil {
		o.UserProperties = make(map[string]string)
	}
	o.UserProperties[key] = value
